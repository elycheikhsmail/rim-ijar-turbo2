...
@import url("/CSS/newtop.css");

@import url("/CSS/recherch_ar_d.css");
@import url("/CSS/recherch_fr_d.css");
@import url("/CSS/cv.css");
#massagem1 { display: block; }
#massagem2 { display: none; }
#massagem3 { display: none; }
#massagem4 { display: none; }

#massaged1 { display: block; }
#massaged2 { display: none; }
#massaged3 { display: none; }
#massaged4 { display: none; }

#bts_desk { display: block; }
#bts_mob { display: none; }
...
.adslot_egf {display:inline-block;width:160px;height:149px; margin-bottom:5px; text-decoration:none;}
...
.Style23 {font-size: 12px; color: #FFFF00; }
.Style24 {color: #FFFF00}
.Style25 {color: #66FFFF}
...
#triecriteresz {display:none}

.adslot_1 {display:none}
#desk_nt { display: none; }

#adsense_v {display:none;}

#bts_desk { display: none; }
#bts_mob { display: block; }
...
<script>
var mssgm = 1;
function disp_mssgm(w) {

   if (mssgm > 4)
      {
		mssgm = 1;
      }
document.getElementById("massagem1").style.display = 'none';
document.getElementById("massagem2").style.display = 'none';
document.getElementById("massagem3").style.display = 'none';
document.getElementById("massagem4").style.display = 'none';
document.getElementById("massagem"+mssgm).style.display = 'block';
...
document.getElementById("massaged1").style.display = 'none';
document.getElementById("massaged2").style.display = 'none';
document.getElementById("massaged3").style.display = 'none';
document.getElementById("massaged4").style.display = 'none';
document.getElementById("massaged"+mssgd).style.display = 'block';
...
<!--
 ...
 function isNumberKeyc(evt)
	...
	function hideFlash() {
		...
		document.getElementById("hflash").style.visibility="hidden";
...
<script type="text/javascript">
<!--
    _CF_checkform_rech = function(_CF_this)
    {
        //reset on submit
...
<script type="text/javascript">
<!--
    _CF_checkform_rech_fr = function(_CF_this)
    {
        //reset on submit
        _CF_error_exists = false;
        _CF_error_messages = new Array();
...
<style type="text/css">
<!--
@import url("/CSS/newtop_b.css");

#toyotam1 { display: block; }
#toyotam2 { display: none; }
#toyotam3 { display: none; }
#toyotam4 { display: none; }
#toyotam5 { display: none; }

#toyotac1 { display: block; }
#toyotac2 { display: none; }
#toyotac3 { display: none; }
#toyotac4 { display: none; }
#toyotac5 { display: none; }
...
<option value="0" >Sous catégorie: tous</option>
</select>
</noscript>
...
<div id="separationf"></div>
  ...
  <dl>
    <dd>
        <select name="prixpar" id="prixpar"  class="requireddropdownlist_fr" >

        <option value="0">Prix Par</option>
...
<dl>
<dt id="dt_fr">Ville</dt>
</dl>

  <dl>
    <dd>
        <select name="lieu_fr" id="lieu_fr"  onchange="lieug_fr()"  class="requireddropdownlist_fr"  onfocusout="lieug_fr()" >

        <option value="0">Ville</option>
        <option value="1">Nouakchott</option>
        <option value="2">Nouadhibou</option>
        <option value="3">Ayoun</option>
        <option value="4">Akjoujt</option>
        <option value="5">Atar</option>
        <option value="6">Aleg</option>
        <option value="7">Kaedi</option>
        <option value="8">Kiffa</option>
        <option value="9">Néma</option>
...
<dt id="dt_fr">Moughataa</dt>
  ...
  <dl>
    <dd>
        <select name="souslieu" id="souslieu"  onchange="secteur()"  class="requireddropdownlist_fr"  onfocusout="secteur()" >

        <option value="0">Moughataa</option>
        <option value="14">Tevragh-Zeina</option>
        <option value="15">Ksar</option>
        <option value="16">Teyarett</option>
        <option value="17">Arafat</option>
        <option value="18">Dar-Naim</option>
        <option value="19">El Mina</option>
    ...
    <div id="paginorder1">
      <table width="100%" border="0">
        <tr>
          ...
          <td nowrap="nowrap">
              <a href="Index.cfm?PN=2" class="Style17">Suivant</a>
                      </td>
          <td nowrap="nowrap"><div id="triecriteresz"><span class="Style14">Trier par: prix </span><a href="Index.cfm?ctid=1&order=3" class="fleche">↑</a>&nbsp;&nbsp;<a href="Index.cfm?ctid=1&order=2" class="fleche">↓</a>&nbsp;<span class="Style14">|</span>&nbsp;<a href="Index.cfm?ctid=1&order=4">Plus Vue</a>&nbsp;<span class="Style14">|</span>&nbsp;<a href="Index.cfm?ctid=1&order=1">Plus récent</a> </div></td>
        </tr>
      </table>
    </div>
...
<div id="photo">
	  ...
	  <img src="https://www.voursa.com/images/noimage.jpg" border="0"/ >
...
<div id="autre_infos">
<span class="StylH2">
Informatique, Téléphones et multimedia<br />
Nouakchott
